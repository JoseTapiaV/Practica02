...
<main>
  <div class="container">
    ...
    <p>Aquí vas a encontrar todos los productos de tu restaurante, solamente haz click en el siguiente botón para que se enlisten todos los productos.
    </p>
    <input type="submit" value="Listar productos" class="w-50 btn btn-secondary" id="listarProducto" name="listarProducto">
